// Generated by Wrangler by running `wrangler types` (hash: 2d3a9b576441256a3d484cdc00e29377)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUN_VERSION" | "GITHUB_API_KEY">> {}
}
