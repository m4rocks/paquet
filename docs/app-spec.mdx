...
- `open-source`: If the app is open source
- `mobile`: Is mobile optimized
- `desktop`: Is desktop optimized
- `auth`: Requires authentication
- `offline`: Works offline
- `data-collection`: Collects user data
...
### `termsAndConditionsUrl` & `privacyPolicyUrl` (optional)

Links pointing to app's terms and conditions and privacy policy pages.
